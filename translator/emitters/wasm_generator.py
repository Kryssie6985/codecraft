"""
📜 WebAssembly Text (WAT) Generator for CodeCraft
==================================================
...
class WASMGenerator:
    ...
    def _generate_module_header(self, ritual_def):
        ...
        self.module_comment = f""";; 🌌 CodeCraft WebAssembly Module
    ...
    def generate_all_schools(self, output_dir: Path) -> List[Path]:
        ...
        for school_key in all_schools:
            try:
                ...
                print(f"⚠️ Failed to generate {school_key}: {e}")
